                ...
                <div className="space-y-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative bg-white rounded-[2rem] p-4 shadow-xl overflow-hidden">
                      <div className="aspect-[4/3] rounded-xl bg-gradient-to-br from-mint/40 via-baby-blue/30 to-lavender/40 flex items-center justify-center">
                        <div className="text-center">
                          <div className="w-20 h-20 mx-auto rounded-full bg-white/80 flex items-center justify-center mb-4 shadow-lg">
                            <MapPin className="w-10 h-10 text-primary" />
                          </div>
                          <p className="font-serif text-xl text-primary">Interactive Map</p>
