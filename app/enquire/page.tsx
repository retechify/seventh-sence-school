                  ...
                  {state.succeeded ? (
                     ...
                     >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                           <Link href="/">
                              <Button className="btn-gradient-yellow text-foreground rounded-full px-10 py-6 text-lg font-bold shadow-lg hover:scale-105 transition-all w-full sm:w-auto">
                                 Back to Home
                              </Button>
                           </Link>
                           <Button 
                           ...
                           <form onSubmit={handleSubmit} className="space-y-10">
                              ...
                              <div className="pt-8 flex flex-col sm:flex-row items-center gap-6 justify-between border-t border-lavender/20">
                                 ...
                                 <Button 
                                    ...
                                    className="w-full sm:w-auto btn-gradient-yellow text-foreground rounded-full px-12 py-8 text-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:scale-105 group disabled:opacity-50"
                                 >
