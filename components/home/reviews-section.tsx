...
const reviews = [
  {
    ...
    review: "Seventh sense school of arts has been a blessing for our family. Emma looks forward to school every single day. The teachers truly care about each child's individual growth.",
    rating: 5,
    avatar: "S",
    color: "peach",
  },
  {
    name: "David Chen",
    role: "Father of Lucas, 3 years",
    review: "The creative approach to learning here is remarkable. Lucas has developed so much confidence and his communication skills have improved tremendously.",
    rating: 5,
    avatar: "D",
    color: "mint",
  },
  {
    ...
    review: "The warmth and love at Seventh sense school of arts is palpable. Aanya has blossomed into a curious, creative, and kind little person. We couldn't be happier!",
    rating: 5,
    avatar: "P",
    color: "lavender",
  },
