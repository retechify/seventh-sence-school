            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left space-y-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#25D366] text-white rounded-full py-3 px-6 font-medium shadow-lg hover:shadow-xl transition-all hover:scale-105"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button 
                  type="submit"
                  className="w-full btn-gradient-purple text-white rounded-full py-6 text-lg font-medium shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]"
                >
                  Enquire Now
                </Button>
