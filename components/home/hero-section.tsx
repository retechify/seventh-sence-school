        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              >
                <Button className="w-full btn-gradient-yellow text-foreground rounded-full px-12 py-8 text-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:scale-[1.03] hover:-translate-y-1 flex items-center justify-center gap-3">
              ...
              <Link href="/enquire" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full bg-white/50 backdrop-blur-sm text-primary border-2 border-primary/20 rounded-full px-10 py-8 text-xl font-bold shadow-md hover:shadow-lg transition-all hover:scale-[1.02] hover:-translate-y-1">
                  Book a Visit
                </Button>
              </Link>
            </motion.div>
