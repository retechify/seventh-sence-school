      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-2 bg-mint/40 border border-mint/20 rounded-full px-4 py-2 text-sm font-bold text-primary">
                <StickerIcon type="star" className="w-4 h-4" />
                <span className="tracking-wide">Admissions Open 2026–27</span>
              </div>
              <div className="inline-flex items-center gap-2 bg-soft-yellow/80 border border-soft-yellow/30 rounded-full px-4 py-2 text-sm font-bold text-primary">
                <StickerIcon type="sparkle" className="w-4 h-4 text-primary" />
                <span className="tracking-wide">Limited Seats Available</span>
              </div>
            </motion.div>
            ...
            >
              <Link href="/enquire" className="w-full sm:w-auto">
                <Button className="w-full btn-gradient-yellow text-foreground rounded-full px-10 py-7 text-lg font-bold shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] hover:-translate-y-1">
                  Book a Free School Visit
                </Button>
              </Link>
              <a href="https://wa.me/918610170313" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button className="w-full bg-white text-primary rounded-full px-8 py-7 text-lg font-bold shadow-lg border-2 border-mint/40 hover:bg-mint/10 transition-all hover:scale-[1.02] hover:-translate-y-1 group">
                  <svg viewBox="0 0 24 24" className="w-6 h-6 mr-2 fill-[#25D366] group-hover:scale-110 transition-transform duration-300">
